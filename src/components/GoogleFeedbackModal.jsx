        ...
        <div className="bg-gradient-to-r from-slate-950 via-blue-950 to-blue-900 p-6 text-white relative overflow-hidden">
          ...
          <div className="flex items-center space-x-3.5 relative z-10">
            ...
            <div>
              ...
              <p className="text-xs text-blue-100/90 font-medium mt-0.5">PHARMART Pharmacy Verified Patient Ratings</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-6 flex-1 overflow-y-auto max-h-[72vh]">
          ...
          {isSubmitted ? (
            <div className="text-center py-8 space-y-4 animate-fade-in">
              <div className="w-20 h-20 rounded-3xl bg-blue-50 text-blue-600 flex items-center justify-center mx-auto border-2 border-blue-200 shadow-xl shadow-blue-500/10">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-10 pr-3.5 py-3 bg-slate-50/80 border border-slate-200 rounded-2xl font-semibold text-slate-800 focus:ring-2 focus:ring-[#2563EB] focus:bg-white outline-hidden transition-all text-xs"
                  />
                </div>
              </div>
