  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white p-6 sm:p-7 rounded-3xl border border-blue-100 shadow-xs flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center space-x-2 bg-blue-50 px-4 py-2.5 rounded-2xl border border-blue-200 text-xs font-extrabold text-blue-800 shrink-0">
              ...
              {filteredKPIs.map((item, idx) => (
                <tr key={idx} className="hover:bg-blue-50/40 transition-colors">
                  ...
                  <td className="py-4 px-5 font-bold text-slate-900">
                    <span className="px-2.5 py-1 rounded-xl bg-blue-50 text-blue-800 border border-blue-200/80 text-[11px] font-extrabold inline-block break-words">
                  ...
                  {/* Target */}
                  <td className="py-4 px-5 text-blue-800 font-black bg-blue-50/40">
                    {item.target}
                  </td>
                  ...
                  <td className="py-4 px-5 text-right">
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-[11px] font-extrabold bg-blue-100 text-blue-900 border border-blue-300 shadow-2xs">
