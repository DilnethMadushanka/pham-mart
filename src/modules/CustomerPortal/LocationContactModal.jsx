  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 overflow-hidden">
        ...
        {/* Header */}
        <div className="bg-[#2563EB] p-5 text-white flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-100">Where to find us & Contact Info</p>
            </div>
          </div>
        ...
        <div className="p-6 space-y-4 text-xs">
          ...
          <div className="p-4 bg-[#F8F9FA] rounded-xl border border-slate-200 space-y-3">
            ...
            <div className="flex items-start space-x-3 border-t border-slate-200 pt-2.5">
              ...
              <div>
                ...
                <a href="tel:055-222-8292" className="text-[#2563EB] font-black text-sm hover:underline">055-222-8292</a>
              </div>
            </div>
          ...
          <div className="h-36 rounded-xl bg-blue-50 border border-blue-200 flex flex-col justify-center items-center text-center p-4 relative overflow-hidden">
            <Navigation className="w-7 h-7 text-[#2563EB] mb-1 animate-bounce" />
          ...
          <button
            ...
            className="w-full py-3 bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-extrabold text-xs rounded-xl shadow-md flex items-center justify-center space-x-2 transition-all"
          >
