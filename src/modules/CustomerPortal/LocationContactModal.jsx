  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 overflow-hidden">
        ...
        {/* Header */}
        <div className="bg-[#0284c7] p-5 text-white flex justify-between items-center">
        ...
        <div className="p-6 space-y-4 text-xs">
          ...
          {/* Map Visual */}
          <div className="h-36 rounded-xl bg-sky-50 border border-sky-200 flex flex-col justify-center items-center text-center p-4 relative overflow-hidden">
          ...
          <button
            ...
            className="w-full py-3 bg-[#0284c7] hover:bg-[#0369a1] text-white font-extrabold text-xs rounded-xl shadow-md flex items-center justify-center space-x-2 transition-all"
          >
